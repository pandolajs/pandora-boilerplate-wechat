 ...
 * @version 1.0.0 | 2018-06-13 | houquan      // 初始版本
*/
...
function log (message = '') {
  ...
  console.log(`${timeStr} [Build]: ${message}`)
}
...
// js alias 编译
gulp.task('build:js:alias', (callback) => {
...
gulp.task('default', ['clean', 'build:config', 'build:less', 'build:js', 'copy', 'compress:image', 'build:font'], () => {
